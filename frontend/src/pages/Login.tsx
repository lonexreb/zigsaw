...
function getTrustedCompanies(): TrustedCompany[] {
  return [
    ...
    { name: 'Umbrella Corp', domain: 'umbrella.com' },
    { name: 'Stark Industries', domain: 'starkindustries.com' },
    { name: 'Wayne Enterprises', domain: 'wayneenterprises.com' },
    { name: 'Soylent', domain: 'soylent.com' },
    { name: 'Massive Dynamic', domain: 'massivedynamic.com' },
    { name: 'Pied Piper', domain: 'piedpiper.com' },
    { name: 'Paperless Post', domain: 'paperlesspost.com' },
    { name: 'Zapier', domain: 'zapier.com' },
    { name: 'Basecamp', domain: 'basecamp.com' },
    { name: 'Gusto', domain: 'gusto.com' },
    { name: 'Bench', domain: 'bench.co' },
    ...
    { name: 'CloudApp', domain: 'getcloudapp.com' },
